   ...
   module Web
      ...
      module Actions
         ...
         def generate_login_session(path, params)
            ...
            # session_cookie = nil
            mini_browser.post(path, params.to_json, rack_env) # do |response|
            ...
            # need to use raw version because the :value in #to_h is not escaped
